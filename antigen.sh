...
rm -f aclocal.m4 configure.scan configure config.h.in depcomp install-sh missing INSTALL compile config.guess config.sub ltmain.sh stamp-h1 autoscan.log lint test-driver
